 ...
 * with libusb: 0x16c0/0x05dc.  Use this VID/PID pair ONLY if you understand
 * the implications!
 */
 ...
 */
#define USB_CFG_VENDOR_NAME     'P', 'a', 'p', 'e', 'A', 'r', 'c', 'a', \
								'd', 'e', '.', 'c', 'o', 'm'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'S', 'i', 'm', 'o', 'C', 'o', 'n', 't', \
								'r', 'o', 'l', 'l', 'e', 'r'
